...
export const mockMarket: MarketData = {
  ...
  net_extra_income: 14000,
  recommendation:
    "Sell in Ahmedabad. Extra ₹5/kg on 2.5 acres = ₹18,500 additional income (net after transport: ₹14,000).",
  price_trend: [51.04, 52.78, 54.52, 56.26, 59.74, 58.58, 58],
  best_time_to_sell: "⚡ Sell Now — Price Peaked",
  sell_badge_color: "green",
  ...
  msp_status: "below",
  msp_message:
    "⚠️ Current price ₹58/kg is ₹13.21 BELOW government MSP (₹71.21/kg). You are legally entitled to sell at MSP. Contact your nearest APMC or government procurement center.",
};
